        ...
        <div className="container">
            <div className="grid grid-cols-6 gap-x-7 gap-y-14 pt-24 pb-12 md:grid-cols-12">
                ...
                <div className="col-span-full sm:col-span-3 md:col-span-2 md:col-start-7">
                    <h3 className="mb-6 font-display text-sm text-white">Marketplace</h3>
                    <ul className="flex flex-col space-y-1 text-jacarta-300">
                        <li>
                ...
                <div className="col-span-full sm:col-span-3 md:col-span-2">
                    <h3 className="mb-6 font-display text-sm text-white">Company</h3>
                    <ul className="flex flex-col space-y-1 text-jacarta-300">
                        <li>
                            <a href="#" className="hover:text-white">
                                Explore
                ...
                <div className="col-span-full sm:col-span-3 md:col-span-2">
                    <h3 className="mb-6 font-display text-sm text-white">My Account</h3>
                    <ul className="flex flex-col space-y-1 text-jacarta-300">
                        <li>
                            <a href="#" className="hover:text-white">
                                Authors
