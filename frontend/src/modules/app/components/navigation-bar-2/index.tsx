                            ...
                            >
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="font-display text-sm text-white">All NFTs</span>
                                    </a>
                                </li>
                                <li>
                                    <a
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="font-display text-sm text-white">Collectibles</span>
                                    </a>
                                </li>
                                <li>
                                    <a
                                    ...
                                    >
                                        ...
                                        <span className="font-display text-sm text-white">Domain Names</span>
                                    </a>
                                </li>
                                <li>
                                    <a
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="font-display text-sm text-white">Photography</span>
                                    </a>
                                </li>
                                <li>
                                    <a
                                    ...
                                    >
                                        ...
                                        <span className="font-display text-sm text-white">Sports</span>
                                    </a>
                                </li>
                                <li>
                                    <a
                                    ...
                                    >
                                        ...
                                        <span className="font-display text-sm text-white">Trading Cards</span>
                                    </a>
                                </li>
                                <li>
                                    <a
                                    ...
                                    >
                                        ...
                                        <span className="font-display text-sm text-white">Utility</span>
                                    </a>
                                </li>
                                <li>
                                    <a
                                    ...
                                    >
                                        ...
                                        <span className="font-display text-sm text-white">Virtual Worlds</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div className="flex items-center justify-center space-x-5">
                        <a href="#" className="group">
                            <svg
                                ...
                                data-prefix="fab"
                                data-icon="facebook"
                                className="h-5 w-5 fill-jacarta-300 group-hover:fill-white"
                                role="img"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512"
                            >
