const NavigationBar3 = () => {
    return (
        <div className="flex items-center px-6 py-6 xl:px-24" style={{ paddingBottom: '1rem', paddingTop: '1rem' }}>
            {/* <!-- Logo --> */}
                                    ...
                                    >
                                        <span className="mr-3 rounded-xl bg-[#E4FCF4] p-[0.375rem]">
                                            <img
                                                ...
                                                src="img/icons/icons8-trending-64.png"
                                            />
                                        </span>
                                        <span className="font-display text-sm text-jacarta-700 dark:text-white">
                                            Trendy
                                ...
                                <li>
                                    ...
                                    >
                                        <span className="mr-3 rounded-xl bg-[#FDF7EE] p-[0.375rem]">
                                            <img
                                                style={{ maxWidth: 24, maxHeight: 24 }}
                                                src="img/icons/icons8-hip-hop-music-96.png"
                                            />
                                        </span>
                                        <span className="font-display text-sm text-jacarta-700 dark:text-white">
                                            Hip Hop
                                ...
                                <li>
                                    ...
                                    >
                                        <span className="mr-3 rounded-xl bg-[#F2EEFF] p-[0.375rem]">
                                            <img
                                                style={{ maxWidth: 24, maxHeight: 24 }}
                                                src="img/icons/icons8-pop-64.png"
                                            />
                                        </span>
                                        <span className="font-display text-sm text-jacarta-700 dark:text-white">
                                            Pop
                                ...
                                <li>
                                    ...
                                    >
                                        <span className="mr-3 rounded-xl bg-[#FFEEFA] p-[0.375rem]">
                                            <img
                                                style={{ maxWidth: 24, maxHeight: 24 }}
                                                src="img/icons/icons8-rock-music-96.png"
                                            />
                                        </span>
                                        <span className="font-display text-sm text-jacarta-700 dark:text-white">
                                            Rock
                                ...
                                <li>
                                    ...
                                    >
                                        <span className="mr-3 rounded-xl bg-[#EAF2FE] p-[0.375rem]">
                                            <img
                                                style={{ maxWidth: 24, maxHeight: 24 }}
                                                src="img/icons/icons8-dj-64.png"
                                            />
                                        </span>
                                        <span className="font-display text-sm text-jacarta-700 dark:text-white">
                                            Electronic
                                    ...
                                    >
                                        <span className="mr-3 rounded-xl bg-[#EBEDFF] p-[0.375rem]">
                                            <img
                                                style={{ maxWidth: 24, maxHeight: 24 }}
                                                className="max-h-7"
                                                src="img/icons/icons8-reggae-64.png"
                                            />
                                        </span>
                                        <span className="font-display text-sm text-jacarta-700 dark:text-white">
                                            Reggae
                                ...
                                <li>
                                    ...
                                    >
                                        <span className="mr-3 rounded-xl bg-[#F5FFED] p-[0.375rem]">
                                            <img
                                                style={{ maxWidth: 24, maxHeight: 24 }}
                                                src="img/icons/icons8-country-64.png"
                                            />
                                        </span>
                                        <span className="font-display text-sm text-jacarta-700 dark:text-white">
                                            Country
                                ...
                                <li>
                                    ...
                                    >
                                        <span className="mr-3 rounded-xl bg-[#FFEEEE] p-[0.375rem]">
                                            <img
                                                style={{ maxWidth: 24, maxHeight: 24 }}
                                                src="img/icons/icons8-ratings-96.png"
                                            />
                                        </span>
                                        <span className="font-display text-sm text-jacarta-700 dark:text-white">
                                            Top Charts
                                ...
                                <li>
                                    ...
                                    >
                                        <span className="mr-3 rounded-xl bg-[#EEFCFF] p-[0.375rem]">
                                            <img
                                                style={{ maxWidth: 24, maxHeight: 24 }}
                                                src="img/icons/icons8-free-96.png"
                                            />
                                        </span>
                                        <span className="font-display text-sm text-jacarta-700 dark:text-white">
                                            Free
