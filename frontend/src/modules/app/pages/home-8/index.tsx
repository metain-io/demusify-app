                                    ...
                                    <div className="rounded-2.5xl bg-jacarta-800 p-10">
                                        <div className="mb-4 md:mb-0">
                                            ...
                                            <p className="text-jacarta-300">
                                                With millions in transactions since 2017, we’ll help you generate
                                                revenue on our platform ⁠— from direct sales to secondary sales
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                >
                    <div className="container relative z-10">
                        ...
                        <p className="mx-auto max-w-md text-center text-lg text-white">
                            Be part of our amazing community and development updates, giveaways, events. Stay tuned for
                            the news.more!
                        </p>
