                ...
                <div className="lg:flex lg:h-full">
                    ...
                    <div className="relative flex items-center justify-center p-[10%] lg:w-1/2">
                        ...
                        <div className="w-full max-w-[25.625rem] text-center">
                            <h1 className="mb-6 font-display text-4xl text-jacarta-700 dark:text-white">Sign in</h1>
                            ...
                            >
                                <li className="nav-item" role="presentation">
                                    ...
                                    >
                                        ...
                                        <span className="font-display text-base font-medium">Ethereum</span>
                                    </button>
                                </li>
                                <li className="nav-item" role="presentation">
                                    <button
                                    ...
                                    >
                                        ...
                                        <span className="font-display text-base font-medium">Torus</span>
                                    </button>
                                </li>
                                <li className="nav-item" role="presentation">
                                    <button
                                    ...
                                    >
                                        ...
                                        <span className="font-display text-base font-medium">Mobile Wallet</span>
                                    </button>
                                </li>
                            </ul>
                            ...
                            <div className="tab-content">
                                ...
                                >
                                    <button
                                        className="js-wallet mb-4 flex w-full items-center justify-center rounded-full border-2 border-transparent bg-accent py-4 px-8 text-center font-semibold text-white transition-all hover:bg-accent-dark"
