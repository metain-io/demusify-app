                                    ...
                                    >
                                        ...
                                        <li>
                                            <a
                                                ...
                                                className="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                                            >
                                                <span className="font-display text-sm text-accent">Home 6</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a
                                ...
                                <article>
                                    <div className="relative overflow-hidden rounded-2.5xl bg-white dark:bg-jacarta-700">
                                        <figure className="relative">
                                            ...
                                            >
                                                <img
                                                    src="./../img/products/item_14_square.jpg"
                                                    alt="item 1"
                                        ...
                                        <div className="pointer-events-none absolute bottom-0 w-full p-5">
                                            ...
                                            <span className="text-2xs text-white">by NFT stars</span>
                                        </div>
                                    </div>
                                </article>
                                <article>
                                    <div className="relative overflow-hidden rounded-2.5xl bg-white dark:bg-jacarta-700">
                                        <figure className="relative">
                                            ...
                                            >
                                                <img
                                                    src="./../img/products/item_27_square.jpg"
                                                    alt="item 1"
                                                    className="w-full object-cover transition-transform duration-[1600ms] will-change-transform group-hover:scale-105"
                                                    height={470}
                                                    width={470}
                                        ...
                                        <div className="pointer-events-none absolute bottom-0 w-full p-5">
                                            ...
                                            <span className="text-2xs text-white">by Lazy Panda</span>
                                        </div>
                                    </div>
                                </article>
                                <article>
                                    <div className="relative overflow-hidden rounded-2.5xl bg-white dark:bg-jacarta-700">
                                        <figure className="relative">
                                            ...
                                            >
                                                <img
                                                    src="./../img/products/item_28_square.jpg"
                                                    alt="item 1"
                                                    className="w-full object-cover transition-transform duration-[1600ms] will-change-transform group-hover:scale-105"
                                                    height={470}
                                                    width={470}
                                ...
                                <article>
                                    <div className="relative overflow-hidden rounded-2.5xl bg-white dark:bg-jacarta-700">
                                        <figure className="relative">
                                            ...
                                            >
                                                <img
                                                    src="./../img/products/item_29_square.jpg"
                                                    alt="item 1"
                                                    className="w-full object-cover transition-transform duration-[1600ms] will-change-transform group-hover:scale-105"
                                                    height={470}
                                                    width={470}
                                        ...
                                        <div className="pointer-events-none absolute bottom-0 w-full p-5">
                                            ...
                                            <span className="text-2xs text-white">by Origin Morish</span>
                                        </div>
                                    </div>
                                </article>
                            </div>
                            ...
                            <article>
                                <div className="relative overflow-hidden rounded-2.5xl bg-white dark:bg-jacarta-700">
                                    <figure className="relative">
                                        ...
                                        >
                                            <img
                                                src="./../img/products/item_20_square.jpg"
                                                alt="item 20"
                                                className="w-full object-cover transition-transform duration-[1600ms] will-change-transform group-hover:scale-105"
                                                height={959}
                                                width={959}
                                    ...
                                    <div className="pointer-events-none absolute bottom-0 w-full p-5">
                                        <h2 className="font-display text-2xl leading-none text-white">TSARÉVNA</h2>
                                        <span className="text-2xs text-white">CryptoGuysNFT</span>
                                    </div>
                                </div>
                            </article>
                        </div>
                                ...
                                <article>
                                    <div className="relative overflow-hidden rounded-2.5xl bg-white dark:bg-jacarta-700">
                                        <figure className="relative">
                                            ...
                                            >
                                                <img
                                                    src="./../img/products/item_30_square.jpg"
                                                    alt="item 1"
                                                    className="w-full object-cover transition-transform duration-[1600ms] will-change-transform group-hover:scale-105"
                                                    height={293}
                                                    width={293}
                                ...
                                <article>
                                    <div className="relative overflow-hidden rounded-2.5xl bg-white dark:bg-jacarta-700">
                                        <figure className="relative">
                                            ...
                                            >
                                                <img
                                                    src="./../img/products/item_10_square.jpg"
                                                    alt="item 1"
                                                    className="w-full object-cover transition-transform duration-[1600ms] will-change-transform group-hover:scale-105"
                                                    height={293}
                                                    width={293}
                                ...
                                <article>
                                    <div className="relative overflow-hidden rounded-2.5xl bg-white dark:bg-jacarta-700">
                                        <figure className="relative">
                                            ...
                                            >
                                                <img
                                                    src="./../img/products/item_31_square.jpg"
                                                    alt="item 1"
                                                    className="w-full object-cover transition-transform duration-[1600ms] will-change-transform group-hover:scale-105"
                                                    height={293}
                                                    width={293}
                                ...
                                <article>
                                    <div className="relative overflow-hidden rounded-2.5xl bg-white dark:bg-jacarta-700">
                                        <figure className="relative">
                                            ...
                                            >
                                                <img
                                                    src="./../img/products/item_32_square.jpg"
                                                    alt="item 1"
                                                    className="w-full object-cover transition-transform duration-[1600ms] will-change-transform group-hover:scale-105"
                                                    height={293}
                                                    width={293}
