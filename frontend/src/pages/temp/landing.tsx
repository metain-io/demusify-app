        ...
        <div className="overflow-x-hidden font-body text-jacarta-500 dark:bg-jacarta-900" itemScope itemType="http://schema.org/WebPage">
            ...
            <header className="js-page-header page-header--transparent fixed top-0 z-20 w-full backdrop-blur transition-colors">
                <div className="flex items-center px-6 py-6 xl:px-24">
                    ...
                    {/* Menu / Mobile CTA */}
                    <div className="js-mobile-menu invisible lg:visible fixed inset-0 z-10 w-full items-center bg-white opacity-0 dark:bg-jacarta-800 lg:relative lg:inset-auto lg:flex lg:bg-transparent lg:opacity-100 dark:lg:bg-transparent">
                        ...
                        <nav className="navbar mt-24 w-full lg:mt-0">
                            <ul className="flex flex-col justify-end lg:flex-row">
                                <li className="group relative">
                                    <a
                                        href="#intro"
                                        className="flex items-center justify-between py-3.5 font-display text-base text-jacarta-700 hover:text-accent lg:px-5 lg:text-white lg:hover:text-white/90"
                                    >
                                        Intro
                                    </a>
                                </li>
                    ...
                    <div className="mx-auto max-w-[90.375rem] px-4">
                        ...
                        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                            ...
                            <a
                                ...
                                className="overflow-hidden rounded-2.5xl bg-white shadow-sm transition-shadow hover:shadow-lg"
                            >
                                <img className="w-full" src="../img/pages/home_7.jpg" alt="Home 7 — Crypto Consultant" />
          ...
          > */}
            ...
            {/* Footer */}
            <footer className="bg-jacarta-800 py-6 text-center">
